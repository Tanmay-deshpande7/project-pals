const Icon = ({ name, size = 24, className = "" }) => {
    ...
    if (name === 'x') {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={{ display: 'inline-block' }}>
    ...
    if (!LucideIcon) return <span className="w-6 h-6 inline-block bg-glass hover:brightness-110 rounded"></span>;
